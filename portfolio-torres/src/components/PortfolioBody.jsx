...
import nutriTurnosImg from "../assets/1.webp";
import simirImg from "../assets/4.webp";
import prestockImg from "../assets/7.webp";
import villaStoreImg from "../assets/8.webp";
      ...
      <section className="py-5" id="projects">
        <div className="container">
          ...
          <div className="row">
            ...
            <ProjectCard
              title="Villa Store"
              description="E-commerce sencillo para la venta de productos varios. Permite gestionar productos, promociones y pedidos."
              image={villaStoreImg}
              buttonLabel="Ver proyecto"
              buttonLink="#contact"
            />
